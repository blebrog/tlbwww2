...
================================================== -->
  <meta charset="utf-8">
  <title>Telbridge Sp. z o.o.</title>
          ...
          <div class="row">
              <div class="col-lg-8 col-md-8">
                <ul class="top-info text-center text-md-left">
                    <li><i class="fas fa-map-marker-alt"></i> <p class="info-text">Telbridge Sp. z o.o.</p>
                    </li>
                </ul>
              </div>
              <!--/ Top info end -->
              ...
              <div class="col-lg-4 col-md-4 top-social text-center text-md-right">
                <ul class="list-unstyled">
                  <li>
                    <a title="Facebook" href="https://pl-pl.facebook.com/Telbridge/">
                        <span class="social-icon"><i class="fab fa-facebook-f"></i></span>
                    </a>
                   <!-- <a title="Twitter" href="https://twitter.com/themefisher.com">
                        <span class="social-icon"><i class="fab fa-twitter"></i></span>
                    </a> -->
                    <a title="Instagram" href="https://www.instagram.com/_telbridge/">
                  ...
                  <li>
                    <div class="info-box">
                      <div class="info-box-content">
                          <p class="info-box-title">Skontaktuj się z nami</p>
                          <p class="info-box-subtitle">(22) 420 57 37</p>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="info-box">
                      <div class="info-box-content">
                          <p class="info-box-title">Adres e-mail</p>
                          <p class="info-box-subtitle">biuro@telbridge.com.pl</p>
                      </div>
                    </div>
                  </li>
                  <li class="last">
                    <div class="info-box last">
                      <div class="info-box-content">
                          <p class="info-box-title">KNF</p>
                          <p class="info-box-subtitle">IP53/2022, PSD2</p>
                      </div>
                    </div>
                  </li>
...
<!--/ Header end -->
<div id="banner-area" class="banner-area" style="background-image:url(images/slider-main/bg1.jpg)">
              ...
              <div class="banner-heading">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                      ...
                      <li class="breadcrumb-item"><a href="index.html">O Nas</a></li>
...
<section id="main-container" class="main-container">
  <div class="container">
    ...
    <div class="row text-center">
      <div class="col-12">
        <h3 class="section-sub-title">Skontaktuj się z nami</h3>
      </div>
    </div>
    <!--/ Title row end -->
      ...
      <div class="col-md-4">
        <div class="ts-service-box-bg text-center h-100">
          ...
          <div class="ts-service-box-content">
            <h4>Nasz Oddział</h4>
            <p>ul. Zagnańska 49, 25-528 Kielce</p>
          </div>
        </div>
      </div><!-- Col 1 end -->
   ...
   <!-- <div class="google-map">
    ...
    <div class="row">
      <div class="col-md-12">
        <h3 class="column-title">Formularz kontaktowy</h3>
...
?>
  ...
  <form id="contact-form" action="#" method="post" role="form">
    ...
    <div class="text-right"><br>
      <button class="btn btn-primary solid blank" type="submit">Wyślij wiadomość</button>
    </div>
          ...
          <div class="col-md-12">
            <div class="copyright-info text-center">
              <span>Copyright &copy; <script>
                ...
                </script>, Telbridge Sp z o.o.</span>
            </div>
          </div>

          <div class="col-md-12">
            <div class="copyright-info text-center">
              <span>Wykonanie DIT Telbridge</span>
            </div>
          </div>
